-- =============================================================================
-- Fix get_star_context enrollment counts to use enrollment_type classification
-- instead of blindly counting by created_at.
--
-- new_last_30_days / new_last_7_days now exclude 'existing_moved' students,
-- so family moves do not inflate enrollment metrics.
-- =============================================================================

-- Update the get_star_context function in-place.
-- We only touch the two enrollment count subqueries inside the 'students' jsonb_build_object.
