      ...
      <section className="ak-hero">
        ...
        <div className="ak-hcontent">
          <h1 className="ak-htitle">
            ...
            <span className="ak-htitle-born">PIANISTS</span>
            <span className="ak-htitle-line3">Are Made.</span>
          </h1>
          <p style={{ fontSize: 18, fontWeight: 400, color: 'rgba(255,255,255,0.75)', fontStyle: 'italic', textAlign: 'center', maxWidth: 560, margin: '16px auto' }}>Piano doesn't just teach music. It teaches how music works. Everything else gets easier after this.</p>
