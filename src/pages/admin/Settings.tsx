...
import { Upload, Check, ChevronDown, ChevronUp, Clock, AlertTriangle, X, Bug } from 'lucide-react'
import { toast } from '../../components/shared/Toast'
import type { Location } from '../../lib/types'
import { useTenantBilling, useCreateCheckout, useCustomerPortal } from '../../hooks/useTenantBilling'
import { useIssues, useCreateIssue, useUpdateIssue, useScreenshotUrl, checkForDuplicateIssue, PAGES, PAGE_SECTION_MAP, CATEGORIES, SEVERITIES, STATUS_COLORS, STATUS_LABELS, DESCRIPTION_MAX_LENGTH, getSectionsForPage, getSubsectionsForSection, type StatusGroup } from '../../hooks/useIssues'
