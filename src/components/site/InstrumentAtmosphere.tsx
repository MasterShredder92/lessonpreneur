...
function makeSymbols(theme: InstrumentTheme): SymbolConfig[] {
  ...
  if (theme === 'guitar') return [
    { type:'char', content:'♪', top:'5%',  left:'8%',  size:44, mobileSize:30, opacity:0.16, rotation:10,  duration:34, delay:0,  driftY:30, driftX:8,  rotDrift:6 },
    { type:'char', content:'♫', top:'40%', left:'85%', size:36, mobileSize:26, opacity:0.14, rotation:-8,  duration:40, delay:6,  driftY:26, driftX:-10,rotDrift:-5 },
    { type:'char', content:'♬', top:'72%', left:'20%', size:32, mobileSize:22, opacity:0.15, rotation:5,   duration:28, delay:12, driftY:34, driftX:6,  rotDrift:7 },
    { type:'char', content:'♩', top:'18%', left:'70%', size:40, mobileSize:28, opacity:0.14, rotation:0,   duration:44, delay:4,  driftY:24, driftX:-8, rotDrift:-4 },
    { type:'char', content:'♪', top:'60%', left:'50%', size:36, mobileSize:26, opacity:0.12, rotation:0,   duration:36, delay:16, driftY:28, driftX:10, rotDrift:8 },
    { type:'char', content:'𝄞', top:'30%', left:'14%', size:52, mobileSize:36, opacity:0.13, rotation:-6,  duration:32, delay:8,  driftY:32, driftX:-6, rotDrift:-6 },
    { type:'char', content:'𝄞', top:'85%', left:'76%', size:44, mobileSize:32, opacity:0.12, rotation:8,   duration:48, delay:20, driftY:20, driftX:8,  rotDrift:5 },
    ...
    { type:'char', content:'♬', top:'52%', left:'36%', size:28, mobileSize:20, opacity:0.14, rotation:0,   duration:38, delay:10, driftY:26, driftX:-8, rotDrift:-7 },
    { type:'char', content:'♪', top:'78%', left:'62%', size:32, mobileSize:24, opacity:0.16, rotation:0,   duration:26, delay:18, driftY:30, driftX:10, rotDrift:6 },
