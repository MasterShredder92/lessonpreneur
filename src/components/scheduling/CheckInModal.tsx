          ...
          <div style={{ marginBottom: 16 }}>
            ...
            {block.student_id && (
              <div style={{ display: 'flex', gap: 8, marginTop: 8, flexWrap: 'wrap' }}>
                <button onClick={() => { onClose(); navigate(`/admin/students?id=${block.student_id}`) }} style={{ display: 'flex', alignItems: 'center', gap: 4, padding: isMobile ? '8px 14px' : '3px 10px', minHeight: isMobile ? 44 : undefined, borderRadius: 8, background: 'rgba(255,255,255,0.04)', border: '1px solid rgba(255,255,255,0.08)', color: '#A0A0C8', fontSize: isMobile ? 13 : 11, fontWeight: 600, cursor: 'pointer' }}>
