...
const STEPS: GuideStep[] = [
  {
    selector: '[data-tour-id="happening-today"]',
  ...
  {
    selector: '[data-tour-id="dash-location-grid"]',
  ...
  {
    selector: '[data-tour-id="active-students-metric"]',
  ...
  {
    selector: '[data-tour-id="schedule-utilization"]',
  ...
  {
    selector: '[data-tour-id="open-slots"]',
    title: 'Open Slots',
  ...
  {
    selector: '[data-tour-id="whats-important"]',
  ...
  {
    selector: '[data-tour-id="closeout-btn"]',
  ...
  useEffect(() => {
    ...
    const tick = () => {
      ...
      if (el) {
        ...
        el.style.animation = 'dashGuidePulse 1.5s ease-in-out infinite'
      ...
      {showToast && (
        <div
          style={{
            ...
            animation: 'dashGuideToast 220ms ease',
            whiteSpace: 'nowrap',
          }}
        >
          Dashboard guide complete. Tap 📖 Guide anytime to replay.
        </div>
      )}
    </>
  )
