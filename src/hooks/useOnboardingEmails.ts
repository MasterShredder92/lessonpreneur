...
import { getPublicAppOrigin } from '../config/zwBrand'
  ...
  return useMutation({
    mutationFn: async () => {
      ...
      for (const tenant of tenants) {
        ...
        const appOrigin = getPublicAppOrigin() || 'https://app.zirowork.io'
        const adminHref = `${appOrigin.replace(/\/$/, '')}/admin`
            ...
            await safeFetch(EDGE_FUNCTIONS.sendEmail, {
              body: {
                ...
                html: `<div style="font-family:-apple-system,sans-serif;max-width:560px;margin:0 auto;padding:32px;background:#101018;border-radius:16px;color:#E0E0F4;">
                  <div style="text-align:center;margin-bottom:24px;font-size:14px;font-weight:700;color:#f59e0b;">ZiroWork</div>
                  ...
                  <div style="text-align:center;margin-top:24px;">
                    <a href="${adminHref}" style="display:inline-block;padding:12px 28px;border-radius:8px;background:#f59e0b;color:#000;text-decoration:none;font-weight:700;font-size:14px;">Open ZiroWork</a>
                  </div>
                  <div style="text-align:center;margin-top:16px;font-size:11px;color:#606088;">ZiroWork — Operating system for music schools</div>
                </div>`,
                from_name: 'ZiroWork',
              },
            })
